...
(deftheme santafe
  "santafe-theme - Created by tmtheme-to-deftheme - 2014-11-16 10:26:39 +0800")
...
(custom-theme-set-faces
 ...
 '(default ((t (:foreground "#F8F8F2" :background "#333333" ))))
 ...
 '(js3-function-param-face             ((t (:foreground "#ff00bb")))) ;;BFC3A9
 ...
 '(font-lock-comment-face ((t (:foreground "#baeb7a"  ))))
 '(font-lock-comment-delimiter-face ((t (:foreground "#649326"  ))))
 '(font-lock-string-face ((t (:foreground "#a1d7f2"  ))))                   ;;primary font color
 '(font-lock-builtin-face ((t (:foreground "#c94d38"  )))) 
 '(font-lock-variable-name-face ((t (:foreground "#dcdf77"  ))))            ;; ret
 '(font-lock-keyword-face ((t (:foreground "#ec691e"  ))))
 '(font-lock-type-face ((t (:foreground "#f7c527"  :underline t))))         ;; function names
 '(font-lock-function-name-face ((t (:foreground "#f7c527"  ))))
 '(font-lock-constant-face ((t (:foreground "#82df91"  ))))                 ;; xml-like tags
...
(provide-theme 'santafe)

;; Local Variables:
;; eval: (when (fboundp 'rainbow-mode) (rainbow-mode +1))
;; End:

;;; santafe-theme.el ends here
